 ...
 * Generated for Laravel 5.2.29 on 2016-04-24.
 *
...
namespace {
    ...
    class Date extends \App\Services\Date\Facades\Date{
         ...
         * @static 
         */
        public static function format($date, $str){
            return \App\Services\Date\DateService::format($date, $str);
        }
         ...
         * @static 
         */
        public static function monthDate($start_date, $end_date = false, $long = true){
            return \App\Services\Date\DateService::monthDate($start_date, $end_date, $long);
        }
         ...
         * @static 
         */
        public static function monthYearDate($date, $long = true){
            return \App\Services\Date\DateService::monthYearDate($date, $long);
        }
         ...
         * @static 
         */
        public static function german($date, $long = true){
            return \App\Services\Date\DateService::german($date, $long);
        }
        ...
        public static function diff($start_date, $end_date){
            return \App\Services\Date\DateService::diff($start_date, $end_date);
        }
    ...
    class Notification extends \App\Services\Notification\Facades\Notification{
        ...
        public static function success($message){
            return \App\Services\Notification\NotificationService::success($message);
        }
        ...
        public static function error($message){
            return \App\Services\Notification\NotificationService::error($message);
        }
        ...
        public static function set($message, $type){
            return \App\Services\Notification\NotificationService::set($message, $type);
        }
        ...
        public static function display(){
            return \App\Services\Notification\NotificationService::display();
        }
